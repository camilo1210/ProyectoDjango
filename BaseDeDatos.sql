...
BEGIN
    -- Aquí va la lógica del trigger
    INSERT INTO `UsuariosAuditoria` (idUsuario, usuarioAnterior, contrasenaAnterior,fechaModificacion)
    VALUES (OLD.idUsuarios, OLD.usuario, OLD.contrasenaUsuario, NOW());
END$$
