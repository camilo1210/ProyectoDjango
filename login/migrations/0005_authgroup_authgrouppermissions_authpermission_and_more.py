...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('login', '0004_rename_nombre_loginusuario_usuario_loginusuario_rol_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('idproveedorauditoria', models.OneToOneField(db_column='idProveedorAuditoria', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='login.proveedor')),
