    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('costo', models.IntegerField(blank=True, db_column='costo', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rol', models.CharField(blank=True, db_column='rol', default='usuario', max_length=45, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('idusuario', models.OneToOneField(db_column='idUsuario', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='login.usuarios')),
                ...
                ('rolanterior', models.CharField(blank=True, db_column='rolAnterior', max_length=45, null=True)),
                ('correoelectronicoanterior', models.CharField(blank=True, db_column='emailAnterior', max_length=45, null=True)),
                ('fechamodificacion', models.DateTimeField(blank=True, db_column='fechaModificacion', null=True)),
            ],
            options={
